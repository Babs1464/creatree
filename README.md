...
```bash
# Using uv
uv pip install git+https://github.com/Babs1464/creatree.git

# Using pip
pip install git+https://github.com/Babs1464/creatree.git
```

### Install as a Tool with uv

```bash
# Install directly as a tool
uv tool install creatree --git https://github.com/Babs1464/creatree.git

# Run the tool (no need to activate any virtual environment)
uv tool run creatree -- [arguments]
```
...
git clone https://github.com/Babs1464/creatree.git
